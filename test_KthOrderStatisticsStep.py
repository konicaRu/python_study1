...
class MyTestCase(unittest.TestCase):
    ...
    def test_six(self):
        ...
        self.assertEqual(a == [1, 2, 3, 4, 5, 6], True)
    ...
    def test_seven(self):
        ...
        self.assertEqual(a == [1, 4, 5, 6, 7, 2, 3], True)
    ...
    def test_seven2(self):
        a = [5, 6, 7, 4, 1, 2, 3]
        self.assertEqual((KthOrderStatisticsStep.KthOrderStatisticsStep(a, 0, 5, 0)) == [0, 2],  True)
        self.assertEqual(a == [1, 4, 5, 6, 7, 2, 3], True)
        self.assertEqual((KthOrderStatisticsStep.KthOrderStatisticsStep(a, 0, 5, 4)) == [2, 5], True)
        self.assertEqual(a == [1, 4, 5, 6, 7, 2, 3], True)
        self.assertEqual((KthOrderStatisticsStep.KthOrderStatisticsStep(a, 0, 5, 2)) == [2],  True)
        self.assertEqual(a == [1, 4, 5, 6, 7, 2, 3], True)

    def test_EITH(self):
        a = [5, 6, 7, 4, 1, 8, 11, 10]
        self.assertEqual((KthOrderStatisticsStep.KthOrderStatisticsStep(a, 0, 7, 0)) == [0, 6], True)
        self.assertEqual(a == [1, 4, 5, 6, 7, 8, 10, 11], True)
        self.assertEqual((KthOrderStatisticsStep.KthOrderStatisticsStep(a, 0, 7, 7)) == [6, 7], True)
        self.assertEqual(a == [1, 4, 5, 6, 7, 8, 10, 11], True)
    ...
    def test_twentySix(self):
        ...
        self.assertEqual(a == [3, 4, 5, 16, 17, 11, 18, 19, 26, 27, 1, 13, 20, 22, 23, 6, 7, 8, 9, 15, 2, 10, 12, 14, 24, 21, 25], True)

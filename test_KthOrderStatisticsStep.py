...
class MyTestCase(unittest.TestCase):
    def test_fore(self):
        a = [5, 4, 1, 2]
        self.assertEqual((KthOrderStatisticsStep.KthOrderStatisticsStep(a, 0, 3, 0)) == [0, 1], True)
        self.assertEqual((KthOrderStatisticsStep.KthOrderStatisticsStep(a, 0, 3, 3)) == [1, 3], True)
